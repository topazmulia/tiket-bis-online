...
<!---728x90-->
	...
	<div class="col-md-7 " >
	 ...
	 <div>
	    ...
	    <div class="">
                  <h3 >Total Amount to Be Paid:<span style="color: red" id="display_total_payable"> Rp. <?php echo $total_amount; ?></span> </h3>
         </div>
		 </br>
        ...
        <div class="clearfix"></div>
		 ...
		 <div>
		   <ul class="nav nav-tabs">            
             <li class="active"><a data-toggle="tab" href="#menu1">Transfer</a></li>
           ...
           <div class="tab-content">
             <div id="menu1" class="tab-pane fade in active">
               <h3>Payment Through Bank Transfer:</h3>
               <p style="font-weight: bolder; color:#001a00">Pay through transfer to this Merchant Bank Account No: <b style="color:red"><?php echo $datacounterPh['contact_no'];?> </b> and enter reference number to get the confirm ticket</p>
               

            <form class="form-inline" method="post">
 
               <div class="form-group ">               
                 <input required type="text" class="form-control" name="reference" id="" placeholder="Reference No.">
               </div>
	...
	<aside id="journey" class="col-md-4 paside agent-right">
          ...
          <ul style="margin-left:2%;">
              ...
              <li><b style="font-weight:bolder;">Ticket Price Per Seat: </b> <span><?php echo $data['fare'];?> IDR</span></li>
