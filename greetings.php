...
<!---728x90-->
	...
	<div class="col-md-7 " >
	 <div>
	    ...
	    <p style="color:#001a00; text-align: justify;">After validate your information and reference number from our end, we will send you a confirmation email. Once you recieve the confirmation email, you will be able to print your ticket. <b>You are suggested to reserve your PNR number above for ticket printing.</b> </p>
	...
	<aside id="journey" class="col-md-4 paside agent-right">
              ...
              <ul style="margin-left:2%;">
                  ...
                  <li><b style="font-weight:bolder;">Total Trip Price: </b> <span><?php echo Session::get("total_amount");?> IDR</span></li>
                  <?php } ?>
